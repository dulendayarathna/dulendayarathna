...
|---|---|---|---|
| **🧠 MindPulse** | AI-powered study companion with 3D interactive flashcards, smart summaries, and self-test quizzes. | `JavaScript` `HTML5` `CSS3` `Gemini API` | [Repo](https://github.com/dulendayarathna/Mind-pulse) |
